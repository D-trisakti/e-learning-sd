...
<html> <!-- Bagian halaman HTML yang akan konvert -->
    ...
    <body>
<div id ="logo" img src ="<?= base_url('assets/'); ?>logo.png"/> 
       ...
       <?php
        ...
        // menampilkan isi tabel dari database ke tabel di aplikasi
                echo "  <tr>
                    ...
                    <td width='200' height='13' align='center' valign='middle'>$data[mapel]</td>
...
<?php
$filename = "LAPORAN DATA PENGAJAR.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
