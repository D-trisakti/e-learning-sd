      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <H3 class="banner-text">Halaman <?= $judul; ?></H3>
            <!-- Topbar Navbar -->
        ...
        ?>
          ...
          <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
              ...
              <!-- Nav Item - Pages Collapse Menu -->
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url() ?>/siswa/detail">
                  <i class="fas fa-fw fa-user-graduate"></i>
                  <span>Siswa</span></a>
              </li>
              <!-- Nav Item - Utilities Collapse Menu -->
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('siswa/tugas') . $user['kelas']; ?> ">
                  <i class="fas fa-fw fa-clipboard-list"></i>
                  <span>Tugas</span></a>
              </li>
              <li class="nav-item">
              ...
              ?>
                ...
                <div id="wrapper">
                  ...
                  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <!-- Nav Item - Pages Collapse Menu -->
                    <li class="nav-item">
                      <a class="nav-link" href="<?= base_url() ?>/guru/detail">
                        <i class="fas fa-fw fa-user-graduate"></i>
                        <span>Guru</span></a>
                    </li>
                    <!-- Nav Item - Pages Collapse Menu -->
                    <li class="nav-item">
                      ...
                      <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                          <a class="collapse-item" href="<?= base_url() ?>/guru/tugas">Riwayat Tugas</a>
                          <a class="collapse-item" href="<?= base_url() ?>/guru/tambah_tugas">Tambah Tugas</a>
                          <a class="collapse-item" href="<?= base_url() ?>/guru/cek_tugas">Cek Tugas</a>
                        </div>
                      </div>
                    </li>
